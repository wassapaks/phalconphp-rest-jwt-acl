...
use App\Models\Memberroles as Memberroles;
use Models\Membersfile as Membersfile;
use Models\Membersdirectory as Membersdirectory;
use Models\Roletemplate as Roletemplate;
use Models\Logininfo as Logininfo;
use Models\Roleitems as Roleitems;
use Models\Membersecurityquestions as Membersecurityquestions;
...
//                $data = array('error' => 'Something went wrong please try again later!', 'statuscode' => 400 );
    ...
    public function memberLogin(){
        ...
        if($this->request->isPost()){
           ...
           $data = $this->userService->authorizeUser(array("username"=>$username,"password"=>$password), "Members");
